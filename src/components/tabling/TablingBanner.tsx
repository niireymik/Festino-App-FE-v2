  ...
  return (
    <>
      <div className="relative">
        <div
          className="w-full min-h-[231px] h-[53.49%] bg-cover bg-right-bottom bg-no-repeat relative"
          style={{
            backgroundImage: `url('/images/tabling/tino-tabling.svg')`,
          }}
        >
          <div className="absolute w-auto h-auto top-[30.65%] dynamic-padding">
